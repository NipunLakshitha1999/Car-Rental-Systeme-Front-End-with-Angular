...
export default class rentCarDTO{
  ...
  constructor(rentid: string, carregno: string, cardate: string, cartime: string, cardiver: string, cusemail: string, customer: customerDTO) {
    this._rentid = rentid;
